...
//         {/* Old Password */}
//         <div className="mb-6">
//           <label className="block mb-2 text-[#505050] font-semibold text-base">Old Password</label>
...
//             >
//               {showOldPassword ? <EyeOff className="h-6 w-6 text-[#505050]" /> : <Eye className="h-6 w-6 text-[#505050]" />}
//             </button>
//           </div>
//         </div>
...
//         {/* New Password */}
//         <div className="mb-6">
//           <label className="block mb-2 text-[#505050] font-semibold text-base">New Password</label>
//           <div className="relative">
//             <input
...
//             >
//               {showNewPassword ? <EyeOff className="h-6 w-6 text-[#505050]" /> : <Eye className="h-6 w-6 text-[#505050]" />}
//             </button>
//           </div>
//         </div>
...
//         {/* Confirm Password */}
//         <div className="mb-8">
//           <label className="block mb-2 text-[#505050] font-semibold text-base">Confirm Password</label>
//           <div className="relative">
//             <input
...
//             >
//               {showConfirmPassword ? <EyeOff className="h-6 w-6 text-[#505050]" /> : <Eye className="h-6 w-6 text-[#505050]" />}
//             </button>
//           </div>
//         </div>
