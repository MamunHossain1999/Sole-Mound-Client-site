  ...
  return (
    <div className="container mx-auto md:pb-18 px-4">
      <div className="flex justify-between items-center py-4">
        <h1 className="text-[28px] md:text-[32px] font-semibold text-[#1F1F1F]">
          Your Account
        </h1>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <h3 className="font-bold mb-1 text-[18px] md:text-2xl text-[#1F1F1F]">
          {title}
        </h3>
        <p className="text-[14px] md:text-base font-normal text-[#1F1F1F]">
          {description}
        </p>
      </div>
    </Link>
